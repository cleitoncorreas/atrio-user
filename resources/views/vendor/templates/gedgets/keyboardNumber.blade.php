    ...
    <div class="input-field col s9 offset-s2">
        <table class="row" id="keybord">
            ...
            <tr>
                ...
                <td><button type="submit" class="btn-floating gradient-45deg-green-teal gradient-shadow btn-large waves-effect waves-light flow-text"><i class="far fa-check-circle"></i></button></td>
            </tr>        
        </table>
    </div>
</div>
