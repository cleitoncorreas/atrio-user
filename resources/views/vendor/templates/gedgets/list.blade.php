                ...
                <ul class="container collection" style="max-height: 262px">
                    @foreach ($lists as $key => $line)
                        <li class="collection-item animate fadeUp delay-{{ $key }} avatar">
                            <img src="./../../../public/img/cars/{{ $line->veiculo->foto }}" alt="" class="circle z-depth-0 responsive-img avatar mt-3" style=" z-index: 0; border-radius:50%;border:2px solid black;">
                            <img src="./../../../public/img/drivers/{{ $line->motorista->foto }}" alt="" class="circle z-depth-0 responsive-img avatar mt-2 ml-4" style=" z-index: 1;width: 50px;height:50px; border-radius:50%;border:2px solid black;">
                            <img src="./../../../public/img/places/{{ $line->localidade->foto }}" alt="" class="circle z-depth-0 responsive-img avatar mt-3 ml-9" style=" z-index: 0; border-radius:50%;border:2px solid black;">
