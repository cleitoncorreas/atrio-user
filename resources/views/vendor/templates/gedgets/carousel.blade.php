            ...
            @switch($dir)
                @case('img\cars')
                    <div class="col s12 carousel-item"  data-cindex="{{ $line->id }}" id="seletor">
                        @if(file_exists(public_path('../../public/'.$dir.'\\'.$line->foto)))
                            <div class="card blue-grey darken-4 z-depth-5 responsive-img border-round" style="background-image:url('../../../../../../public/{{ str_replace('\\','/',$dir) }}/{{ $line->foto }}');width: 100%;height: 100%;background-size:cover;background-position:cover;">
                        @else 
                            <div class="card blue-grey darken-4 z-depth-5 responsive-img border-round" style="background-image:url('../../../../../../public/img/img-default.jpg');width: 100%;height: 100%;background-size: cover;background-position:center">
                        @endif
                ...
                @case('img\drivers')
                    <div class="col s12 carousel-item"  data-cindex="{{ $line->funcionario->id }}" id="seletor">
                        @if(file_exists(public_path('../../public/'.$dir.'\\'.$line->foto)))
                            <div class="card blue-grey darken-4 z-depth-5 responsive-img border-round" style="background-image:url('../../../../../../public/{{ str_replace('\\','/',$dir) }}/{{ $line->foto }}');width: 100%;height: 100%;background-size:cover;background-position:center;">
                        @else
                            <div class="card blue-grey darken-4 z-depth-5 responsive-img border-round" style="background-image:url('../../../../../../public/img/img-default.jpg');width: 100%;height: 100%;background-size:cover;background-position:center">
                        @endif
                                <div class="center">
