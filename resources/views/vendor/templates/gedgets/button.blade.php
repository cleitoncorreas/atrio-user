@switch($button)
    ...
    @case(2)
        ...
        <div class="@yield('animated-option','animated zoomIn') row center col s12 mb-3">
            <a href="@yield('button-option2-href')" class="@yield('button-option2-color','gradient-45deg-indigo-blue') gradient-shadow btn-large z-depth-5 waves-effect waves-light border-round col s12">@yield('button-option2-name')<!--<i class="material-icons ml-6 left">cloud_download</i>--></a>
        </div>
    @break
    ...
    @case(3)
        ...
        <div class="@yield('animated-option','animated zoomIn') row center col s12 mb-3">
            ...
            <a href="@yield('button-option3-href')" class="@yield('button-option3-color','gradient-45deg-indigo-blue') gradient-shadow btn-large z-depth-5 waves-effect waves-light border-round col s12">@yield('button-option3-name')<!--<i class="material-icons ml-6 left">cloud_download</i>--></a>
        </div>
    @break
