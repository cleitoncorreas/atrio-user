...
@section('options')
    ...
    <div class="row center col s12">
        <a href="" id="download-button" class="gradient-45deg-indigo-light-blue blue btn-large z-depth-5 waves-effect waves-light border-round pulse col s12">Enviar</a>
    </div>
